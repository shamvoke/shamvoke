...
let phrases=["All cursors have a point! Let that click.","Crafting pixels into art, one design at a time.","Kindness is free, sprinkle that stuff everywhere.","Creativity is just intelligence having fun."],target=document.getElementById("shamtext"),typewriter=new Typewriter(target,{loop:!0,delay:55,deleteSpeed:30});phrases.forEach(e=>{typewriter.typeString(e).pauseFor(1800).deleteAll().pauseFor(400)}),typewriter.start();

...
1. Open Google. ~~Or your favourite search engine~~
1. Search for the application you want.
1. Trust your gut to find the official website.
1. Find the actual download page.
1. Ignore the twenty **"Download Now"** buttons.
1. Download the installer.
1. Open installer and click install.
1. Click Next.
1. Agree to some terms and conditions you'll never read.
1. Click Next again.
1. Uncheck the browser toolbar, antivirus trial, or whatever bundleware they try sneaking in.
1. Click Finish.
...
They introduced [Winget](https://learn.microsoft.com/en-us/windows/package-manager/winget/), their official package manager.

There's also [Chocolatey](https://chocolatey.org/), one of the most popular community package managers, and tools like [Scoop](https://scoop.sh/) for developers.
...
Visit the official website [here](https://devolutions.net/unigetui/), download the installer, and complete the installation like any normal Windows application.
...
Then checking each application individually...

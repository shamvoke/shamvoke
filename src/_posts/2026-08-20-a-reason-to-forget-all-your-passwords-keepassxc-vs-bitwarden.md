...
[Bitwarden](https://bitwarden.com/) was the first password manager that made me properly understand why password managers exist.
...
~~Fueled by curiosity,~~ I decided to give [KeePass](https://keepass.info/) a try.
...
[KeePassXC](https://keepassxc.org/) is a fork of KeePass, designed as a modern, cross-platform password manager.
